    ...
    <div className="p-3 md:p-12 2xl:py-24 2xl:px-36 lg:space-y-24">
      <section className="grid grid-cols-1 md:grid-cols-2 items-center justify-center py-12 md:py-0 md:p-12">
        <div className="hidden md:flex flex-col items-center justify-center">
          <div className="flex bg-blue md:h-[500px] md:w-[500px]">s</div>
        </div>
        <div className="flex flex-col items-start justify-center space-y-5 md:p-8 2xl:pl-24">
          <h2 className="text-3xl lg:text-4xl font-semibold text-blue">
            <span className="text-gold">Asesoría Jurídica</span> Especializada
            en Materia Civil y Mercantil
          </h2>
          <p className="text-sm md:text-base text-neutral-500">
            Enfrentar retos legales puede ser complicado, pero contar con el
            respaldo adecuado marca la diferencia. Ofrecemos servicios
            especializados en derecho civil y mercantil, diseñados para proteger
            tus intereses y garantizar soluciones efectivas. Ya sea en la
            elaboración y revisión de contratos, recuperación de cartera,
            resolución de disputas comerciales o asesoría en temas
            patrimoniales, nuestro compromiso es brindarte estrategias
            personalizadas y una representación sólida. Con años de experiencia,
            estamos listos para guiarte en cada paso del proceso legal,
            asegurando un enfoque profesional y orientado a resultados.
          </p>
          <Link
            href={"/contacto"}
        ...
        <div className="flex md:hidden flex-col items-center justify-center">
          <div className="flex bg-blue h-[400px] w-full md:h-[500px] md:w-[500px] mt-6 md:mt-0">
            s
          </div>
        </div>
      </section>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 items-center justify-center py-12 md:py-0 md:p-12">
        <div className="flex flex-col items-start space-y-5 md:p-8 2xl:pl-32">
          <h2 className="text-3xl lg:text-4xl font-semibold text-blue">
            <span className="text-gold">Asesoría Jurídica </span> en Materia
            Familiar
          </h2>
          <p className="text-sm md:text-base text-neutral-500">
            En los asuntos legales relacionados con la familia, es fundamental
            contar con el apoyo de expertos que comprendan la importancia de
            cada decisión. Ofrecemos un servicio integral y sensible para
            ayudarte a resolver temas como divorcios, custodia de menores,
            pensiones alimenticias, adopciones y sucesiones. Nuestro enfoque
            combina experiencia legal con empatía, asegurando que cada caso se
            trate con profesionalismo y cuidado. Estamos comprometidos a
            brindarte soluciones legales claras y efectivas, priorizando siempre
            el bienestar de tu familia y protegiendo tus derechos en cada paso
            del proceso.
          </p>
          <Link
            href={"/contacto"}
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 items-center justify-center py-12 md:py-0 md:p-12">
        ...
        <div className="flex flex-col items-start justify-center space-y-5 md:p-8 2xl:pl-24">
          <h2 className="text-3xl lg:text-4xl font-semibold text-blue">
            <span className="text-gold">Servicio </span> de Corresponsalía
            Jurídica
          </h2>
          <p className="text-sm md:text-base text-neutral-500">
            Facilitamos la representación legal eficiente y profesional para
            despachos y empresas que requieren apoyo en diversas jurisdicciones.
            Nuestro servicio de corresponsalía jurídica garantiza una gestión
            puntual y efectiva de tus asuntos legales, incluyendo
            notificaciones, seguimiento de expedientes, presentación de
            promociones y audiencias. Con un equipo altamente capacitado y
            conocimiento profundo del marco legal, nos convertimos en tu aliado
            estratégico para fortalecer tu presencia en donde lo necesites.
            Confía en nosotros para actuar con compromiso, confidencialidad y un
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 items-center justify-center py-12 md:py-0 md:p-12">
        <div className="flex flex-col items-start space-y-5 md:p-8 2xl:pl-32">
          <h2 className="text-3xl lg:text-4xl font-semibold text-blue">
            <span className="text-gold">Gestión </span> de Trámites ante
            Dependencias
          </h2>
          <p className="text-sm md:text-base text-neutral-500">
            Simplificamos tus procesos legales y administrativos con un servicio
            especializado en la gestión de trámites ante diversas dependencias
            gubernamentales y organismos públicos. Nos encargamos de realizar
            gestiones como inscripción de actas, obtención de licencias,
            registros, permisos y más, asegurando cumplimiento y eficiencia en
            cada paso. Nuestro equipo cuenta con la experiencia necesaria para
            agilizar procedimientos y resolver posibles obstáculos,
            permitiéndote ahorrar tiempo y esfuerzo. Confía en nosotros para
            llevar a cabo tus trámites con profesionalismo y puntualidad.
          </p>
          <Link
            href={"/contacto"}
            className="flex items-center space-x-2 text-gold"
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 items-center justify-center py-12 md:py-0 md:p-12">
        ...
        <div className="flex flex-col items-start justify-center space-y-3 md:p-8 2xl:pl-24">
          <h2 className="text-3xl lg:text-4xl font-semibold text-blue">
            <span className="text-gold">Procedimiento </span> de Rescisión o
          ...
          <p className="text-sm md:text-base text-neutral-500">
            ...
            consecuencias legales que correspondan, como el pago de daños y
            perjuicios.
          </p>
          <p className="text-sm md:text-base text-neutral-500">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 items-center justify-center py-12 md:py-0 md:p-12">
        <div className="flex flex-col items-start space-y-5 md:p-8 2xl:pl-32">
          <h2 className="text-3xl lg:text-4xl font-semibold text-blue">
            <span className="text-gold">Controversias </span> de Arrendamiento
          </h2>
          <p className="text-sm md:text-base text-neutral-500">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 items-center justify-center py-12 md:py-0 md:p-12">
        ...
        <div className="flex flex-col items-start justify-center space-y-3 md:p-8 2xl:pl-24">
          <h2 className="text-3xl lg:text-4xl font-semibold text-blue">
            <span className="text-gold">Cobros </span> y Defensa de Pagarés
          </h2>
          <p className="text-sm md:text-base text-neutral-500">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 items-center justify-center py-12 md:py-0 md:p-12">
        <div className="flex flex-col items-start space-y-5 md:p-8 2xl:pl-32">
          <h2 className="text-3xl lg:text-4xl font-semibold text-blue">
            <span className="text-gold">Juicio de Otorgamiento</span> y Firma de
            Escritura
          </h2>
          <p className="text-sm md:text-base text-neutral-500">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 items-center justify-center py-12 md:py-0 md:p-12">
        ...
        <div className="flex flex-col items-start justify-center space-y-5 md:p-8 2xl:pl-24">
          <h2 className="text-3xl lg:text-4xl font-semibold text-blue">
            <span className="text-gold">Elaboración </span> y Revisión de
            Contratos
          </h2>
          <p className="text-sm md:text-base text-neutral-500">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 items-center justify-center py-12 md:py-0 md:p-12">
        <div className="flex flex-col items-start space-y-5 md:p-8 2xl:pl-32">
          <h2 className="text-3xl lg:text-4xl font-semibold text-blue">
            <span className="text-gold">Juicios </span> Hipotecarios
          </h2>
          <p className="text-sm md:text-base text-neutral-500">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 items-center justify-center py-12 md:py-0 md:p-12">
        ...
        <div className="flex flex-col items-start justify-center space-y-5 md:p-8 2xl:pl-24">
          <h2 className="text-3xl lg:text-4xl font-semibold text-blue">
            <span className="text-gold">Asesoría Legal</span> a Condominios
          </h2>
          <p className="text-sm md:text-base text-neutral-500">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 items-center justify-center py-12 md:py-0 md:p-12">
        <div className="flex flex-col items-start space-y-5 md:p-8 2xl:pl-32">
          <h2 className="text-3xl lg:text-4xl font-semibold text-blue">
            <span className="text-gold">Elaboración y Revisión</span> de
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 items-center justify-center py-12 md:py-0 md:p-12">
        ...
        <div className="flex flex-col items-start justify-center space-y-5 md:p-8 2xl:pl-24">
          <h2 className="text-3xl lg:text-4xl font-semibold text-blue">
            <span className="text-gold">Trámites</span> ante Dependencias
          </h2>
          <p className="text-sm md:text-base text-neutral-500">
