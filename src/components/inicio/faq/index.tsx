        ...
        <div className="grid sm:grid-cols-2 gap-6 md:gap-12">
          <div>
            ...
            <p className="mt-2 text-sm text-gray-500">
              ...
              Distinctio tempore aut numquam sapiente. Maxime optio possimus
              amet enim facilis minima illo rem eligendi voluptatibus. Eaque
              inventore quasi aut illum doloremque!
            </p>
          </div>
